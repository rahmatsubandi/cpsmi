...
<div id="comments">
  ...
  <div id="comments-data">
    ...
    <div id="comments-<?php echo $commentNo ?>" class="comments__item probootstrap-animate <?php echo ($isAdmin) ? 'comments__item-admin' : '' ?>">
      ...
      <div class="comments__footer text-right">
        <a class="btn btn-default btn-sm article__comment-delete" data-comment="comments-<?php echo $commentNo ?>" data-action="<?php echo base_url('page/delete_comment/'.$item->id) ?>">
  ...
  <div class="comments__input probootstrap-animate">
    ...
    <form id="article__form-comment" method="post" action="<?php echo base_url('page/post_comment/'.$data->id) ?>">
